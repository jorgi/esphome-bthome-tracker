...
enum BTHomeDataType {
  ...
  BTHOME_MEASUREMENT_PM25 = 0x0D, // Deprecated but supported
  BTHOME_MEASUREMENT_PM10 = 0x0E, // Deprecated but supported
  BTHOME_MEASUREMENT_HUMIDITY_PRECISE = 0x0F,
  BTHOME_MEASUREMENT_MOISTURE = 0x10,
  BTHOME_MEASUREMENT_CO2 = 0x12,
  BTHOME_MEASUREMENT_VOC = 0x13,
  BTHOME_MEASUREMENT_GAS = 0x14,
  BTHOME_MEASUREMENT_COUNT_LEGACY = 0x15, // Deprecated
  BTHOME_MEASUREMENT_PM25_2 = 0x1A,
  BTHOME_MEASUREMENT_PM10_2 = 0x1B,
  BTHOME_MEASUREMENT_COUNT_M = 0x3D,
  BTHOME_MEASUREMENT_COUNT_L = 0x3E,
  BTHOME_MEASUREMENT_DISTANCE_MM = 0x40,
  BTHOME_MEASUREMENT_DISTANCE_M = 0x41,
  BTHOME_MEASUREMENT_DURATION = 0x42,
  BTHOME_MEASUREMENT_TEMPERATURE_PRECISE = 0x45,
  BTHOME_MEASUREMENT_UV_INDEX = 0x46,
  BTHOME_MEASUREMENT_VOLUME_L = 0x47,
  BTHOME_MEASUREMENT_VOLUME_ML = 0x48,
  BTHOME_MEASUREMENT_VOLUME_FLOW_RATE = 0x49,
  BTHOME_MEASUREMENT_VOLUME_FLOW = 0x4E,

  // Complex Types (recognized but not fully parsed yet)
  BTHOME_MEASUREMENT_GYROSCOPE = 0x50,
  BTHOME_MEASUREMENT_ACCELERATION = 0x51,
  BTHOME_TIMESTAMP = 0x5D,
  BTHOME_TEXT = 0x5E,
  BTHOME_RAW = 0x5F,
  
  // Event-based Types
  BTHOME_BUTTON_EVENT = 0x5A
};
